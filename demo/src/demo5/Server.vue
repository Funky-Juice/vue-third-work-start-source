<template>
  <demo-container>
    <button class="button" role="button" @click="fetchPosts">
      Получить все сообщения
    </button>
    <button class="button" role="button" @click="getPostById">
      Получить одно сообщение
    </button>
    <button class="button" role="button" @click="createPost">
      Создать сообщение
    </button>
    <button class="button" role="button" @click="updatePost">
      Редактировать сообщение
    </button>
    <button class="button" role="button" @click="deletePost">
      Удалить сообщение
    </button>
  </demo-container>
